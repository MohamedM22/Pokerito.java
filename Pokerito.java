...
public class Pokerito {
    public static void main(String[] args) {
        ...
        System.out.println(" • If are the matches are equal, everyone's a winner!\n");
        System.out.println(" • Ready? Typer anything if you are.");
    ...
    public static String randomCard() {
        double randomNumber = Math.random() * 13; // 0 - 12.9999999
        randomNumber +=1;
